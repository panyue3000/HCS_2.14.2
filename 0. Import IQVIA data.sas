...
infile 'C:\Users\panyue\Box\1 Healing Communities\DATA_NYS\PAN\2.14.2 IQVIA\Import\Projected_Naloxone_Distributions.csv' 
...
data redivis_export;
	retain PROJECTED_NRX PROJECTED_NQTY PROJECTED_TRX PROJECTED_TQTY PROJECTED_TCOST PROJECTED_TPRICE 
MONTH_YEAR_CODE PRODUCT_DESCRIPTION COMBINED_MOLECULE STATE_CODE COUNTY DSPNSD_NDC_CODE 
DAYS_SUPPLY_NUMBER PAY_TYPE_DESC;
set redivis_export;
