...
outfile= %TSLIT (C:\Users\wfd14\Box\1 Healing Communities\DATA_NYS\PAN\2.14.2 IQVIA\HCS deliveries\&DATA..CSV)
replace;
run;
...
proc export data=&DATA. dbms=CSV
outfile= %TSLIT (C:\Users\wfd14\Box\1 Healing Communities\DATA_NYS\PAN\2.14.2 IQVIA\Export\&DATA..CSV)
replace;
run;
